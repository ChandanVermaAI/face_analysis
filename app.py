...
if st.button("Camera Testing",key="testing"):
    try:
...
if st.session_state.camera_detected:
    ...
    if st.button("Open System Camera",key="system Check"):
        logger.info("Running face detection function")
